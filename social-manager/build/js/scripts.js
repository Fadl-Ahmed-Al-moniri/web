...
var options = function(type, height, numbers , color){
  ...
  if (analytics_1 != null && typeof(analytics_1) != 'undefined') {
      var chart = new ApexCharts(analytics_1[0], options("area" , '66px' , numArr(19,99) , '#4fd1c5')); 
      var chart_1 = new ApexCharts(analytics_1[1], options("area" , '66px' , numArr(10,99) , '#dade57')); 
      chart.render();       
      chart_1.render();       
  }
